...
export default function ScavengerHunt() {
    return (
        <div className="flex items-center justify-center p-4 h-[70vh] flex-col w-[95%] mx-auto py-4 mt-20 mb-20">
            ...
            <p className="text-left p-4 pt-2">
            ...
            <p className="text-lg font-semibold p-4 pb-0">Hint #1:</p>
            <p className="text-left p-4 pt-2">&quot;Under the rocket&apos;s glow, where lanterns brightly show, find the secret code that&apos;s ready to blow!&quot;</p>
            <p className="text-gray-400 p-4 pb-0">Done with this hint?</p>
