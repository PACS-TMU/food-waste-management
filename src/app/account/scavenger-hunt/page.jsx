...
export default function ScavengerHunt() {
    return (
        <div className="flex items-center justify-center p-4 h-[70vh] flex-col">
            ...
            <p className="text-lg text-left p-6 pt-2">
            ...
            <p className="text-lg text-left p-6 pt-2">&quot;Under the rocket&apos;s glow, where lanterns brightly show, find the secret code that&apos;s ready to blow!&quot;</p>
