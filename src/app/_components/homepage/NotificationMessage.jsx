...
export default function NotificationMessage({ isNotification, setNotification }) {
    return (
        <div className={`notification max-w-[768px] w-[95vw] md:w-[500px] top-0 min-h-[19vh] rounded-md shadow-md mt-[-1vh] pt-[1vh] bg-white z-20 ${isNotification ? 'fixed' : 'hidden'}`}>
